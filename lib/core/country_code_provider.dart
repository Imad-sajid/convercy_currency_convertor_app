...
class CountryCodeProvider with ChangeNotifier {
  static final Map<String, String> _currencyToCountryCode = {
    ...
    'FOK': 'FO', 'GBP': 'GB', 'GEL': 'GE', 'GHS': 'GH', 'GIP': 'GI',
    ...
    'SEK': 'SE', 'SGD': 'SG', 'SHP': 'SH', 'SLL': 'SL', 'SOS': 'SO',
    'SRD': 'SR', 'SSP': 'SS', 'STN': 'ST', 'SYP': 'SY', 'SZL': 'SZ',
    'THB': 'TH', 'TJS': 'TJ', 'TMT': 'TM', 'TND': 'TN', 'TOP': 'TO',
    'TRY': 'TR', 'TTD': 'TT', 'TWD': 'TW', 'TZS': 'TZ', 'UAH': 'UA',
  ...
  //   'BTC', 'ETH', 'BCH', 'LTC', 'XRP', 'EOS'
  // ];


  String getCountryCode(String currency) {
    return _currencyToCountryCode[currency] ?? 'EU';
  }
}
